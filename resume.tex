...
\cvitem{Front-end}{Angular versions 2 to 11, React, Symfony, Apache Cordova, HTML5, CSS3, SCSS, SASS}
...
\cvitem{Other}{Git, continuous integration (Jenkins, Github), containers (Docker), Bitbucket, Karma, Unit testing}

\section{Experience}
\cventry{Oct 2022--Current}{Software Engineer}{Aimsun}{Barcelona, Spain}{React front-end development, Git versioning control, GitLab, Jira, Bitbucket, Jenkins, Mapbox, Scrum, JavaScript, TypeScript, Unit testing}{}
