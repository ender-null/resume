...
\begin{entrylist}
	...
	\entry
		...
		{Cofundé la sociedad que opera \textbf{LoveLust} y \textbf{Zierzo}, y la dirijo como CEO sin dejar de ser su responsable técnico -- LoveLust llega a los \textbf{16.000 usuarios activos mensuales} con monetización por suscripción. Gestiono la \textbf{arquitectura}, la ingeniería de releases y las operaciones en App Store y Google Play de ambos productos, además de la administración, el cumplimiento normativo y los proveedores de la empresa. También desarrollo \textbf{sitios web para pequeños negocios locales}. \\
