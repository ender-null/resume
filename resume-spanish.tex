...
\textbf{Móvil:} React Native, Expo, EAS, Cordova, publicación en App Store y Google Play\\
...
\textbf{Metodologías:} Agile, Scrum, internacionalización (i18n / l10n), autenticación y autorización, MFA, SaaS, mentoría
...
\begin{entrylist}
	...
	\entry
		...
		{Constituí la sociedad que opera \textbf{LoveLust} y \textbf{Zierzo} tras alcanzar ambos una tracción sostenida -- LoveLust llega a los \textbf{16.000 usuarios activos mensuales} con monetización por suscripción. Gestiono la \textbf{arquitectura}, la ingeniería de releases y las operaciones en App Store y Google Play de ambos productos, además de la administración, el cumplimiento normativo y los proveedores de la empresa. \\
	...
	\entry
		...
		{Por cuenta propia}
		{Diseñé, desarrollé y lancé \textbf{LoveLust} y \textbf{Zierzo} desde cero hasta \textbf{App Store y Google Play} -- almacenamiento seguro, funcionalidades en tiempo real, analítica de uso y facturación por suscripción -- gestionando el ciclo de vida completo, incluidos \textbf{CI/CD}, \textbf{tests automatizados} y la publicación en tiendas. La tracción de ambos productos llevó a constituir \textbf{The Lovelust Company, SL} en mayo de 2026. También desarrollé \textbf{sitios web para pequeños negocios locales}. \\
